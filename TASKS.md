...
> ⚠️ **UI는 TDD 적용 제외**: 자동화된 테스트 작성하지 않음. 수동 테스트만 진행.
...
- [ ] 각도 모드 설정
- [ ] 테마 설정 (향후)
- [ ] **수동 테스트**: LocalStorage 확인

---

## 🎯 Phase 6: 통합 테스트 및 디버깅 (2-3일)

### 6.1 코어 로직 통합 테스트 (자동화)
- [ ] Parser + Evaluator 통합 테스트
- [ ] Calculator Engine 전체 플로우 테스트
- [ ] 복잡한 수식 계산 테스트
- [ ] 엣지 케이스 테스트
- [ ] 모든 테스트 통과 확인
...
- [ ] **수동**: 각도 모드 전환 확인
- [ ] **수동**: 오류 메시지 표시 확인
- [ ] **수동**: 브라우저 호환성 테스트 (Chrome, Firefox, Safari)

### 6.3 버그 수정
- [ ] 발견된 버그 목록 작성
- [ ] 우선순위별 버그 수정
- [ ] 코어 로직 버그는 테스트 추가 후 수정 (TDD)
- [ ] UI 버그는 수동 확인 후 수정

### 6.4 성능 최적화
- [ ] 계산 속도 측정 (console.time)
- [ ] DOM 조작 최적화
- [ ] 메모이제이션 적용 (필요시)
